...
class AddTodoPopupCardLaps extends StatefulWidget {
  /// {@macro add_todo_popup_card}
  const AddTodoPopupCardLaps({Key? key}) : super(key: key);

  @override
  State<AddTodoPopupCardLaps> createState() => _AddTodoPopupCardLapsState();
}

class _AddTodoPopupCardLapsState extends State<AddTodoPopupCardLaps> {
  ...
  SendLapsData() async {
    ...
    final modelDetailCar = await ItemModelLap (
      itemPic: imgUrl,
      date: time,
      detail: detail,
    ...
    if (user != null) {
      await FirebaseFirestore.instance.collection('laps').doc(time).set(jsonCar);
    }
