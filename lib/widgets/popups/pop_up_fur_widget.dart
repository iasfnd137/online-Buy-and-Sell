...
class AddTodoPopupCardFur extends StatefulWidget {
  /// {@macro add_todo_popup_card}
  const AddTodoPopupCardFur({Key? key}) : super(key: key);

  @override
  State<AddTodoPopupCardFur> createState() => _AddTodoPopupCardFurState();
}

class _AddTodoPopupCardFurState extends State<AddTodoPopupCardFur> {
  ...
  SendFurData() async {
    ...
    final modelDetailCar = ItemModelFur (
      itemPic: imgUrl,
      date: time,
      detail: detail,
    ...
    if (user != null) {
      await FirebaseFirestore.instance.collection('fur').doc(time).set(jsonCar);
    }
