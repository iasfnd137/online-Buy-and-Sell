...
class AddTodoPopupCardCars extends StatefulWidget {
  /// {@macro add_todo_popup_card}
  const AddTodoPopupCardCars({Key? key}) : super(key: key);

  @override
  State<AddTodoPopupCardCars> createState() => _AddTodoPopupCardCarsState();
}

class _AddTodoPopupCardCarsState extends State<AddTodoPopupCardCars> {
  final detailController = TextEditingController();
  final itemNameController = TextEditingController();
  final itemPriceController = TextEditingController();
  String heroAddTodo = 'add-todo-hero';
  ...
  getPic() {
    if (pickedImage != null) {
      ...
      return Icon(Icons.add,size: 150,color: Colors.white,);
    }
  }
  ...
  SendCarData() async {
    ...
    var itemPrice = itemPriceController.text;

    final modelDetailCar = await ItemModelCar (
      itemPic: imgUrl,
      date: time,
      detail: detail,
    ...
    if (user != null) {
      await FirebaseFirestore.instance.collection('cars').doc(time).set(jsonCar);
    }
