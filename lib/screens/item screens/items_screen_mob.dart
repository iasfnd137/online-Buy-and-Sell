...
import '../../models/item models/item_model_mob.dart';
import '../../models/number_model.dart';
import '../../models/olbs_model.dart';
import '../../services/hero_dialog_route.dart';
import '../../widgets/drawer.dart';
import '../../widgets/popups/pop_up_mob_widget.dart';

class ItemsScreenMob extends StatefulWidget {
  const ItemsScreenMob({Key? key}) : super(key: key);

  @override
  State<ItemsScreenMob> createState() => _ItemsScreenMobState();
}

class _ItemsScreenMobState extends State<ItemsScreenMob> {
  User? user;
  DatabaseReference? userRef;
  UserModel? userModel;
  ItemModelMob? itemModel;
  ...
  Stream<List<ItemModelMob>> readItem() => FirebaseFirestore.instance
      .collection('mobs')
      .orderBy('date', descending: true)
      .snapshots()
      .map((snapshots) => snapshots.docs
          .map((doc) => ItemModelMob.fromMap(doc.data()))
          .toList());

  updateFirestore() {
    if (itemRef != null) {
      FirebaseFirestore.instance.collection('mobs').doc(time).update({
  ...
  openwhatsapp(ItemModelMob item) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:
            ...
            userModel?.uid != null
                ? StreamBuilder<List<ItemModelMob>>(
                    stream: readItem(),
  ...
  Widget buildItems(ItemModelMob items) => items.itemPic != null
      ? Padding(
