...
import '../../models/item models/item_car_model.dart';
import '../../models/number_model.dart';
import '../../models/olbs_model.dart';
import '../../services/hero_dialog_route.dart';
import '../../widgets/drawer.dart';
import '../../widgets/popups/pop_up_car_widget.dart';


class ItemsScreenCars extends StatefulWidget {
  const ItemsScreenCars({Key? key}) : super(key: key);

  @override
  State<ItemsScreenCars> createState() => _ItemsScreenCarsState();
}

class _ItemsScreenCarsState extends State<ItemsScreenCars> {
  User? user;
  DatabaseReference? userRef;
  ItemModelCar? itemModel;
  DatabaseReference? itemRef;
  UserModel? userModel;
  ItemModelCar? itemModelCarModel;
  ...
  Stream<List<ItemModelCar>> readItem() => FirebaseFirestore.instance
      .collection('cars')
      .orderBy('date', descending: true)
      .snapshots()
      .map((snapshots) =>
          snapshots.docs.map((doc) => ItemModelCar.fromMap(doc.data())).toList());
  ...
  openwhatsapp(ItemModelCar itemModel) async{
    var whatsapp = itemModel.num;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: GestureDetector(
          onTap: () {
            Navigator.of(context).push(HeroDialogRoute(
                builder: (context) {
                  return const AddTodoPopupCardCars();
                },
        ...
        body:
            ...
            userModel?.uid != null
                ? StreamBuilder<List<ItemModelCar>>(
                    stream: readItem(),
  ...
  Widget buildItems(ItemModelCar items) => items.itemPic != null
      ? Padding(
