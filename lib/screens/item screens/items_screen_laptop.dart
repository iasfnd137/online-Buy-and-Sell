...
import '../../models/item models/item_lap_model.dart';
import '../../models/number_model.dart';
import '../../models/olbs_model.dart';
import '../../services/hero_dialog_route.dart';
import '../../widgets/popups/pop_up_laps_widget.dart';

class ItemsScreenLaptop extends StatefulWidget {
  const ItemsScreenLaptop({Key? key}) : super(key: key);

  @override
  State<ItemsScreenLaptop> createState() => _ItemsScreenLaptopState();
}

class _ItemsScreenLaptopState extends State<ItemsScreenLaptop> {
  User? user;
  DatabaseReference? userRef;
  UserModel? userModel;
  ItemModelLap? itemModel;
  ...
  Stream<List<ItemModelLap>> readItem() => FirebaseFirestore.instance
      .collection('laps')
      .orderBy('date', descending: true)
      .snapshots()
      .map((snapshots) => snapshots.docs
          .map((doc) => ItemModelLap.fromMap(doc.data()))
          .toList());

  updateFirestore() {
    if (itemRef != null) {
      FirebaseFirestore.instance.collection('laps').doc(time).update({
  ...
  openwhatsapp(ItemModelLap item) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: GestureDetector(
          onTap: () {
            Navigator.of(context).push(HeroDialogRoute(
                builder: (context) {
                  return const AddTodoPopupCardLaps();
                },
        ...
        body:
            ...
            userModel?.uid != null
                ? StreamBuilder<List<ItemModelLap>>(
                    stream: readItem(),
  ...
  Widget buildItems(ItemModelLap items) => items.itemPic != null
      ? Padding(
