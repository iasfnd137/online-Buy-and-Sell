...
import '../../widgets/popups/pop_up_charity_widget.dart';


class ItemsScreenCarity extends StatefulWidget {
  const ItemsScreenCarity({Key? key}) : super(key: key);

  @override
  State<ItemsScreenCarity> createState() => _ItemsScreenCarityState();
}

class _ItemsScreenCarityState extends State<ItemsScreenCarity> {
  User? user;
  ...
  Stream<List<ItemModelCharity>> readItem() => FirebaseFirestore.instance
      .collection('charity')
      .orderBy('date', descending: true)
      .snapshots()
      .map((snapshots) =>
          snapshots.docs.map((doc) => ItemModelCharity.fromMap(doc.data())).toList());
  ...
  openwhatsapp(ItemModelCharity itemModel) async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: GestureDetector(
          onTap: () {
            Navigator.of(context).push(HeroDialogRoute(
                builder: (context) {
                  return const AddTodoPopupCardCharity();
                },
        ...
        body:
            ...
            userModel?.uid != null
                ? StreamBuilder<List<ItemModelCharity>>(
                    stream: readItem(),
  ...
  Widget buildItems(ItemModelCharity items) => items.itemPic != null
      ? Padding(
