...
import '../../models/item models/item_Fur_model.dart';
import '../../models/number_model.dart';
import '../../models/olbs_model.dart';
import '../../services/hero_dialog_route.dart';
import '../../widgets/popups/pop_up_fur_widget.dart';



class ItemsScreenFur extends StatefulWidget {
  const ItemsScreenFur({Key? key}) : super(key: key);

  @override
  State<ItemsScreenFur> createState() => _ItemsScreenFurState();
}

class _ItemsScreenFurState extends State<ItemsScreenFur> {
  User? user;
  DatabaseReference? userRef;
  UserModel? userModel;
  ItemModelFur? itemModel;
  DatabaseReference? furRef;
  ...
  Stream<List<ItemModelFur>> readItem() => FirebaseFirestore.instance
      .collection('fur')
      .orderBy('date', descending: true)
      .snapshots()
      .map((snapshots) =>
          snapshots.docs.map((doc) => ItemModelFur.fromMap(doc.data())).toList());
  ...
  openwhatsapp(ItemModelFur item) async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: GestureDetector(
          onTap: () {
            Navigator.of(context).push(HeroDialogRoute(
                builder: (context) {
                  return const AddTodoPopupCardFur();
                },
        ...
        body:
            ...
            userModel?.uid != null
                ? StreamBuilder<List<ItemModelFur>>(
                    stream: readItem(),
  ...
  Widget buildItems(ItemModelFur items) => items.itemPic != null
      ? Padding(
